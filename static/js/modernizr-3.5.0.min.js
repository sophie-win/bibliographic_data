!function (e, t, n) {
    ...
    function a() {
        ...
        for (var l in T) if (T.hasOwnProperty(l)) {
            ...
            for (a = r(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) i = e[o], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = a : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = a), x.push((a ? "" : "no-") + s.join("-"))
        }
    }
    ...
    function v(e, t, a, o) {
        ...
        for (p = e.length, f = 0; p > f; f++) if (m = e[f], g = D.style[m], c(m, "-") && (m = l(m)), D.style[m] !== n) {
    ...
    function y(e, t, n, a, o) {
        var i = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + q.join(i + " ") + i).split(" ");
    ...
    w._prefixes = C;
    var S = t.documentElement, E = "svg" === S.nodeName.toLowerCase();
    E || !function (e, t) {
        function n(e, t) {
    ...
    var k = "Moz O ms Webkit", _ = w._config.usePrefixes ? k.toLowerCase().split(" ") : [];
    w._domPrefixes = _;
    var P;
    !function () {
    ...
    w.hasEvent = z, Modernizr.addTest("audio", function () {
        var e = s("audio"), t = !1;
        try {
    ...
    var N = s("input"), R = "autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),
        $ = {};
    Modernizr.input = function (t) {
        for (var n = 0, r = t.length; r > n; n++) $[t[n]] = !!(t[n] in N);
        return $.list && ($.list = !(!s("datalist") || !e.HTMLDataListElement)), $
    }(R);
    var A = "search tel url email datetime date month week time datetime-local number range color".split(" "), j = {};
    Modernizr.inputtypes = function (e) {
        for (var r, a, o, i = e.length, s = "1)", l = 0; i > l; l++) N.setAttribute("type", r = e[l]), o = "text" !== N.type && "style" in N, o && (N.value = s, N.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && N.style.WebkitAppearance !== n ? (S.appendChild(N), a = t.defaultView, o = a.getComputedStyle && "textfield" !== a.getComputedStyle(N, null).WebkitAppearance && 0 !== N.offsetHeight, S.removeChild(N)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? N.checkValidity && N.checkValidity() === !1 : N.value != s)), j[e[l]] = !!o;
        return j
    }(A), Modernizr.addTest("hsla", function () {
        var e = s("a").style;
        return e.cssText = "background-color:hsla(120,40%,100%,.5)", c(e.backgroundColor, "rgba") || c(e.backgroundColor, "hsla")
    });
    var B = "CSS" in e && "supports" in e.CSS, L = "supportsCSS" in e;
    ...
    w.mq = M;
    var O = w.testStyles = d, V = function () {
    ...
    V ? Modernizr.addTest("fontface", !1) : O('@font-face {font-family:"font";src:url("https://")}', function (e, n) {
        var r = t.getElementById("smodernizr"), a = r.sheet || r.styleSheet,
    ...
    w._cssomPrefixes = q;
    var H = function (t) {
        var r, a = C.length, o = e.CSSRule;
        if ("undefined" == typeof o) return n;
        if (!t) return !1;
        if (t = t.replace(/^@/, ""), r = t.replace(/-/g, "_").toUpperCase() + "_RULE", r in o) return "@" + t;
        for (var i = 0; a > i; i++) {
            var s = C[i], l = s.toUpperCase() + "_" + r;
    ...
    w.testAllProps = b, Modernizr.addTest("cssanimations", b("animationName", "a", !0)), Modernizr.addTest("backgroundsize", b("backgroundSize", "100%", !0)), Modernizr.addTest("borderimage", b("borderImage", "url() 1", !0)), Modernizr.addTest("borderradius", b("borderRadius", "0px", !0)), Modernizr.addTest("boxshadow", b("boxShadow", "1px 1px", !0)), function () {
    ...
    }(), Modernizr.addTest("flexbox", b("flexBasis", "1px", !0)), Modernizr.addTest("cssreflections", b("boxReflect", "above", !0)), Modernizr.addTest("csstransforms", function () {
        ...
        return e
    }), Modernizr.addTest("csstransitions", b("transition", "all", !0)), a(), o(x), delete w.addTest, delete w.addAsyncTest;
